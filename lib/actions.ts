...
// export async function generateTrackSuggestionsAsText(userPrompt: string): Promise<string | null> {
...
// async function getTrackURI(track: BasicTrackInfo): Promise<string | null | undefined> {
...
// async function createPlaylist(title: string, prompt: string): Promise<Playlist | null | undefined> {
//     try {
